...
Una vez el servidor ha sido instalado, ejecuta el siguiente comando para iniciar el servidor. Tu sitio web será accesible por defecto desde `http://localhost:4000` por defecto. Cuando esté ejecutándose, Hexo vigilará las modificaciones de los ficheros y actualizará automáticamente, por lo que no será necesario reiniciar el servidor.
...
Hexo ejecuta el servidor por defecto en `0.0.0.0`. Se puede modificar la IP por defecto.
