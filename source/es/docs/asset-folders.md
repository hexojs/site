...
Una vez habilitado, cada imagen dentro de la carpeta de recursos del artículo, será referenciada correctamente a su ruta correspondiente. Por ejemplo, "imagen.jpg" se guarda en "/2020/01/02/foo/imagen.jpg", implicando que es una imagen del artículo "/2020/01/02/foo/", `![](imagen.jpg)` será renderizado como `<img src="/2020/01/02/foo/image.jpg">`.
