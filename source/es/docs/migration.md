...
Primero, instala el complemento `hexo-migrator-rss`.
...
Primero, instala el complemento `hexo-migrator-wordpress`.
...
Primero, instala el complemento `hexo-migrator-joomla`.
